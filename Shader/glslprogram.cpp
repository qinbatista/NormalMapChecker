...
bool GLSLProgram::Create(char *file0, char *file1, char *file2, char *file3, char *file4, char *file5)
{
...
bool GLSLProgram::CreateHelper(char *file0, ...)
{
    GLsizei n = 0;
    GLchar *buf;
    Valid = true;
...
void GLSLProgram::DisableVertexAttribArray(const char *name)
{
    int loc;
...
void GLSLProgram::EnableVertexAttribArray(const char *name)
{
    int loc;
    if ((loc = GetAttributeLocation((char *)name)) >= 0)
    {
...
void GLSLProgram::SetAttributePointer3fv(char *name, float *vals)
{
    int loc;
...
void GLSLProgram::SetAttributeVariable(char *name, float val)
{
    int loc;
    if ((loc = GetAttributeLocation(name)) >= 0)
    {
...
void GLSLProgram::SetAttributeVariable(char *name, float val0, float val1, float val2)
{
    int loc;
    if ((loc = GetAttributeLocation(name)) >= 0)
    {
...
void GLSLProgram::SetAttributeVariable(char *name, float vals[3])
{
    int loc;
    if ((loc = GetAttributeLocation(name)) >= 0)
    {
...
void GLSLProgram::SetUniformVariable(char *name, int val)
{
    int loc;
...
void GLSLProgram::SetUniformVariable(char *name, float val)
{
    int loc;
    if ((loc = GetUniformLocation(name)) >= 0)
    {
...
void GLSLProgram::SetUniformVariable(char *name, float val0, float val1, float val2)
{
    int loc;
    if ((loc = GetUniformLocation(name)) >= 0)
    {
...
void GLSLProgram::SetUniformVariable(char *name, float vals[3])
{
    int loc;
